...
(function applyControl() {
  ...
  const sections = ['about','vision','offer','support','contact','moderator','maester','miester_pool','maker','maker_pool','session','program','cost'];
  sections.forEach(s => {
...
// ── 페이지별 렌더링 ──
{
  ...
  if (currentPage === 'members') {
    ...
    renderMaesters(membersData.maesters, 'maesters-content');
    renderMaesters(membersData.miesterPool || [], 'miester-pool-content');
